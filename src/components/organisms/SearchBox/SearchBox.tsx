        ...
        <Container>
            <Row className='mx-5 mt-5 px-5' lg={11} >
                <Col className={'d-flex flex-column align-self-center mt-5'} style={{ textAlign: 'center' }}>
                    ...
                    <TextInput className={'styledSearchBox'} placeholder='Enter your school/professor' onChange={props.onChange} />
                    <div style={{ backgroundColor: 'lightblue' }}>
                        {props.professorsToRender.length > 0 && props.professorsToRender.map((prof: any) => <div>
                            <h6 onClick={() => { navigate(`professor-details/${prof._id}`) }}>{prof.professorName}</h6>
